...
export default function LandingPage() {
  ...
  <div id="hero" data-section="hero">
      ...
      testimonials={[
        { name: "Anna S.", handle: "@annastyle", testimonial: "The perfect dress for my event! Super easy process.", rating: 5, imageSrc: "http://img.b2bpic.net/free-photo/young-beautiful-woman-outdoor_624325-50.jpg" },
        { name: "Claire B.", handle: "@clairelooks", testimonial: "High quality pieces and excellent customer service.", rating: 5, imageSrc: "http://img.b2bpic.net/free-photo/cheerful-female-friends-sitting-together-using-tablet-discussing-clothes-purchases-fashion-store-copy-space-consumerism-shopping-concept_74855-11590.jpg" },
        { name: "Jessica M.", handle: "@jessm", testimonial: "Sustainable and so stylish. Highly recommend!", rating: 5, imageSrc: "http://img.b2bpic.net/free-photo/portrait-young-beautiful-sexy-woman-with-two-horns-hairstyle-shows-tongue_158538-5924.jpg" },
        { name: "Sarah P.", handle: "@sarahp", testimonial: "Jam Pure made my gala night seamless.", rating: 5, imageSrc: "http://img.b2bpic.net/free-photo/groom-balcony-holding-glass-engjoying-sunny-weather-balcony_8353-12235.jpg" },
        { name: "Emily V.", handle: "@emilyv", testimonial: "The best way to try new designers.", rating: 5, imageSrc: "http://img.b2bpic.net/free-photo/blonde-woman-talking-phone_23-2148660693.jpg" },
      ]}
  ...
  <div id="testimonials" data-section="testimonials">
      ...
      useInvertedBackground={false}
      testimonials={[
        { id: "1", name: "Sarah J.", role: "Marketing", company: "GrowthCo", rating: 5, imageSrc: "http://img.b2bpic.net/free-photo/young-joyful-lady-with-dark-curly-hair-sunglasses-standing-happily-looking-camera-while-spending-time-summer-terrace-cafe_574295-5934.jpg" },
        { id: "2", name: "Michael C.", role: "CTO", company: "TechLab", rating: 5, imageSrc: "http://img.b2bpic.net/free-photo/female-personal-shopper-helping-cutomer_23-2148924090.jpg" },
        { id: "3", name: "Emily R.", role: "Creative", company: "DesignCo", rating: 5, imageSrc: "http://img.b2bpic.net/free-photo/cheerful-lady-formal-wear-showing-peace-sign_197531-16827.jpg" },
        { id: "4", name: "David K.", role: "PM", company: "Startup", rating: 5, imageSrc: "http://img.b2bpic.net/free-photo/woman-posing-with-elegant-clothes-office_291650-564.jpg" },
        { id: "5", name: "Alex T.", role: "Developer", company: "Innovate", rating: 5, imageSrc: "http://img.b2bpic.net/free-photo/happy-friends-shopping-clothes_23-2148385702.jpg" },
      ]}
